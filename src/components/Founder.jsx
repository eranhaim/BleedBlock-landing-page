      ...
      <div className="founder-content">
        ...
        >
          ...
          <p className="founder-title">
            מייסד BleedBlock | לוחם וחובש לשעבר בצה״ל
          </p>
          <p className="founder-bio">
            דוד התחיל את דרכו בתחום הרפואה כבר ב-2017 כחובש, העביר קורסי
            עזרה ראשונה, ושירת כמפקד בגדוד 82 בצנחנים. במהלך המלחמה נלחם
          ...
          <p className="founder-bio">
            ...
            ובלי ציוד שנותן מענה אמיתי. דוד היה מקור הטיפול הראשוני היחיד
